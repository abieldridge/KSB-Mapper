...
ksb_data = {
    "L2 Horticulture Operative": sorted([
        ...
        "K9: Understand how plant pests and diseases are introduced into a site — for example, via infected plants, soil, tools, water, wind, or human activity. Includes knowledge of pests like aphids, vine weevils, slugs, and diseases like mildew, honey fungus, box blight, and rust. Also includes good biosecurity and hygiene practices to prevent spread ",
        ...
        "K26: Techniques of establishing ornamental turf and wild flower meadows",
        ...
        "S7: Be able to identify and report symptoms or signs of common UK plant pests (e.g. aphids, vine weevils, red spider mites), plant pathogens (e.g. honey fungus, box blight, powdery mildew), and disorders (e.g. nutrient deficiency, drought stress, frost damage). This includes noticing leaf damage, spots, discolouration, mould, pest activity, wilting, or unusual growth, and reporting it accurately using the correct terminology",
        ...
        "S18: Provide aftercare to recently installed turf and maintain established turf or wild flower meadows including irrigation, maintenance, monitoring health and protection from use",
